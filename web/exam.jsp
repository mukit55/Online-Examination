        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function displayResult()
                {
                    ...
                    var total = rightAns + wrongAns + noAns;
                    var result = rightAns + "," + wrongAns + "," + noAns + "," + total;
    ...
    <body>
        ...
        <div class="row">
            ...
            <div style="padding: 50px;" class="col-sm-3">
                ...
                <button id="startBtn" style="margin-top:20px;"   >Start Exam</button>
                <br/>
                <button id="submitBtn" style="margin-top:60px;"  >Submit</button>
                <button id="cancelBtn" style="margin-top:60px;" >Cancel</button>
